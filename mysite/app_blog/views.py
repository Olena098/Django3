...
from .models import Article, Category  # Не забудь імпортувати Category!

# Оновлений HomePageView, щоб відображати категорії та публікації на головній
class HomePageView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Отримуємо статті для головної сторінки (відображаються тільки статті з main_page=True)
        context['articles'] = Article.objects.filter(main_page=True)[:5]
        return context

    def get_queryset(self, *args, **kwargs):
        # Отримуємо всі категорії для відображення на головній
...
class ArticleCategoryList(ArticleList):
    def get_queryset(self, *args, **kwargs):
        # Отримуємо статті за категорією
